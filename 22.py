...
# Menyimpan hasil dalam file Excel
results_df = pd.DataFrame(creator_results)
results_df.to_excel("top_10_creators.xlsx", index=False)

results_df = pd.DataFrame(influencer_results)
results_df.to_excel("top_10_influencers.xlsx", index=False)
